...
const SECTIONS: Section[] = [
  {
    ...
    items: [
      ...
      { name: 'Audiencias', href: '/admin/audiencias', icon: 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z' },
    ],
  },
  {
    key: 'legal',
    ...
    items: [
      {
        name: 'Mercantil', href: '/admin/mercantil', modulo: 'mercantil' as Modulo,
        icon: 'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4',
        children: [
          { name: 'Entidades', href: '/admin/mercantil/entidades' },
          { name: 'Actas de Asamblea', href: '/admin/mercantil/actas-asamblea' },
          { name: 'Certificación de Actas', href: '/admin/mercantil/certificacion-actas' },
          { name: 'Nombramientos', href: '/admin/mercantil/nombramientos' },
        ],
      },
      { name: 'Laboral', href: '/admin/laboral', modulo: 'laboral' as Modulo, icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z' },
      {
        ...
        children: [
          { name: 'Escrituras', href: '/admin/notariado/escrituras' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Llamadas', href: '/admin/llamadas', icon: 'M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z' },
      { name: 'Descargar Adjuntos', href: '/admin/descargar-adjuntos', icon: 'M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z' },
    ],
  },
  {
    key: 'contenido',
